...
<style>
    ...
    /* Portal layer — ALWAYS force black text (portal bg is always white) */
    body > div[data-baseweb="layer"] *,
    body > div[data-baseweb="layer"] li,
    body > div[data-baseweb="layer"] span,
    body > div[data-baseweb="layer"] [data-baseweb="option"] {{
        color: #000000 !important;
        background-color: #ffffff !important;
    }}
    body > div[data-baseweb="layer"] [data-baseweb="option"]:hover,
    body > div[data-baseweb="layer"] [aria-selected="true"] {{
